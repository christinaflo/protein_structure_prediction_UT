...
#--------------------------------------------------------------------------------------------
# NOTE: The following two functions were borrowed from cu-ssp. Accuracy function was used in
# order to compare results using the same metric, the other is a simple utility function to read data.
